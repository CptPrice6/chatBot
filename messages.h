...
namespace Msg
{
    ...
    extern const std::string ASK_MATH_OR_LIFE_MESSAGE = "do you want to solve some math problems?\nIf not, just say that you want to talk about life and we can talk about other things :) (Keyword - life)\n";
    extern const std::string BYE_MESSAGE = "it was nice talking to you! Shall we continue our conversation? (yes / no) If you do not want to, just say that you want to solve some math problems to take on a challenge!\n";

    extern const std::string INTRODUCE_MATH_CHATBOT_MESSAGE = "firstly, I will present myself. I am Math chatBot v3! Nice to meet you.\n";
    extern const std::string INTRODUCE_LIFE_CHATBOT_MESSAGE = "firstly, I will present myself. I am Life chatBot v3! Nice to meet you.\n";
    ...
    extern const std::string STUDIES_FINISHED_MESSAGE = "how many years are left till your studies are finished?\n";
    ...
    extern const std::string CONTINUE_OR_MATH_MESSAGE = "It was nice talking to you! Shall we continue our conversation?\nIf you do not want to, just say that you want to solve some math problems to take on a challenge! (Keyword - math)\n";
    ...
    extern const std::string ASK_MATH_DIFFICULTY_FIRST_MESSAGE = "okay, perfect. Now tell me do you want to solve easy, normal or hard math problems or say that you want to talk about life to switch the topic :) (Keyword - life)\n";
    ...
    extern const std::string INCORRECT_BAD_MOOD_MESSAGE = "haha! Nope. The correct answer was : ";
    extern const std::string INCORRECT_NORMAL_MOOD_MESSAGE = "wrong! The correct answer was : ";
    extern const std::string INCORRECT_GOOD_MOOD_MESSAGE = "almost! The correct answer was : ";
    ...
    extern const std::string NAME_DIFFICULTY_MESSAGE = "can you stop playing with me? Just name a difficulty please :/ or switch the topic (Keyword - life)\n";
    extern const std::string SPECIFY_DIFFICULTY_MESSAGE = "please specify a difficulty (easy/normal/hard)... or maybe you want to talk about other topics? (Keyword - life)\n";
